      ...
      {rating > 0 && rating <= 3 && (
        <>
          <textarea
            ...
            className="w-full px-3 py-2.5 bg-secondary border border-border focus:border-primary focus:outline-none rounded-[10px] text-[13px] resize-none mb-3 transition-colors"
            rows={3}
          />
          <button
            onClick={onSubmit}
            className="w-full py-2.5 bg-primary hover:bg-primary text-primary-foreground text-[13px] font-semibold rounded-lg transition-colors"
          >
            Submit Feedback
          </button>
        </>
